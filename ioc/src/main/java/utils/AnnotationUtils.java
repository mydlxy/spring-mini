...
public class AnnotationUtils {
    ...
    public static void getBeanDefinition(String className,Class beanClass,List<BeanDefinition> beanDefinitions){
        ...
        for (Field field : fields) {
            ...
            if(val != null){
                beanDefinition.setProperty(field.getName(),val.value());
            }else {
                Autowired autowired = field.getAnnotation(Autowired.class);
                beanDefinition.setPropertyReference(field.getName(),field.getType().getTypeName());
            }
        }
...
//    public static boolean matchClass(Class beanClass,Class target){
//
//    }
